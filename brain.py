...
class CommandParser:
    ...
    PATTERNS = {
        ...
        "draw": [
            r"(?:нарисуй|создай\s+картинку|изобрази)\s+(.+)",
            r"картинка\s+(.+)",
        ],
        "remind": [
            r"(?:напомни|напомни\s+мне)\s+(?:через\s+)?(\d+)\s+(?:минут|минуты|мин)\s+(.+)",
            r"(?:напомни|напомни\s+мне)\s+(.+)\s+(?:через\s+)?(\d+)\s+(?:минут|минуты|мин)",
        ],
        "ask_kb": [
